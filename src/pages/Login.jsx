              ...
              <div className="relative">
                ...
                {passwordVisible ? (
                  <IoMdEye
                    ...
                    className="absolute top-[50%] translate-[-50%] right-1 w-5 h-5 z-30 cursor-pointer"
                  />
                ) : (
                  <IoMdEyeOff
                    onClick={handleEyeClick}
                    className="absolute top-[50%] translate-[-50%] right-1 w-5 h-5 z-30 cursor-pointer mt-[0.2px]"
                  />
                )}
              </div>
              <div>
